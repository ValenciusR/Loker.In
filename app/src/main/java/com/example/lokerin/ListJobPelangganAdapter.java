...
public class ListJobPelangganAdapter extends RecyclerView.Adapter<ListJobPelangganAdapter.CardViewHolder> implements Filterable {

    private List<JobData> jobDataList;
    private List<JobData> filteredList;
    private Context context;

    public ListJobPelangganAdapter(Context context, List<JobData> jobDataList) {
